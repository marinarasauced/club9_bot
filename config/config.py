...
ENABLE_MONITORING_ON_STARTUP_BOOL = False
...
MONITORING_KEYWORDS_1 = ["start", "stop", "enable", "disable", "refresh"]
MONITORING_KEYWORDS_2_ENABLE = ["rewards", "activities"]
MONITORING_KEYWORDS_2_DISABLE = ["rewards", "activities"]
MONITORING_KEYWORDS_2_REFRESH = ["rewards", "activities"]